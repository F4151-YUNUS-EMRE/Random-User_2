    ...
    <main>
      ...
      <div className="block">
        <div className="container">
          ...
          <p className="user-value"> {value||person?.name?.first+""+person?.name?.first} </p>
          <div className="values-list">
            <button onMouseOver={handleInfo} className="icon" data-label="name">
              <img src={person.gender==="female"?womanSvg:manSvg} alt="user" id="iconImg" />
            </button>
            <button onMouseOver={handleInfo} className="icon" data-label="email">
              <img src={mailSvg} alt="mail" id="iconImg" />
            </button>
            <button onMouseOver={handleInfo} className="icon" data-label="age">
              <img src={person.gender==="female"?womanAgeSvg:manAgeSvg} alt="age" id="iconImg" />
            </button>
            <button onMouseOver={handleInfo} className="icon" data-label="street">
              <img src={mapSvg} alt="map" id="iconImg" />
            </button>
            <button className="icon" data-label="phone">
              <img onMouseOver={handleInfo} src={phoneSvg} alt="phone" id="iconImg" />
            </button>
            <button onMouseOver={handleInfo} className="icon" data-label="password">
